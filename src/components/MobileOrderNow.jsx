  ...
  return (
    <div className='w-dvw h-dvh bg-white'>
        <div className='flex flex-col items-center pt-24'>
            ...
            <div className='grid grid-cols-2 size-90 place-content-center place-items-center gap-x-4 gap-y-8 h-full'>
                <motion.div
                    variants={containerVariants}
                    initial="hidden"
                    animate="visible"
                ...
                >
                    <motion.img 
                        ...
                        className='rounded-2xl bg-black/90 bg-cover bg-center shadow-lg/30' 
