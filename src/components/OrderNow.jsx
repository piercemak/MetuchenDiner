    ...
    <div className='w-full h-dvh bg-white'>
        <div className='flex flex-col items-center pt-6'>
            <motion.div 
                ...
                initial="hidden"
                animate="visible"                 
                className="pb-12 pr-4 gap-2 w-full flex flex-col items-end"
            >
                <motion.span variants={sectionVariants} className='text-[20px] michroma '>PLACE ORDER WITH</motion.span>
                <motion.div variants={sectionVariants} className="w-[40%] h-[1px] bg-red-900/90" ></motion.div>
            </motion.div>
            
            <div className='grid grid-cols-3 place-content-center place-items-center gap-x-24 gap-y-8 h-full pr-100 2xl:pr-[600px] pt-4'>
                <motion.div
                    variants={containerVariants}
                    initial="hidden"
                    animate="visible"
                ...
                >
                    <motion.img 
                        ...
                        whileHover={{ scale: 1.05, boxShadow: "0 4px 20px #d83621", }}
                        whileTap={{ scale: 0.95, transition: { type: "spring", stiffness: 700, damping: 10 } }}                          
                        src="images/logos/DoordashLogo.svg" 
                        className='size-48 2xl:size-[300px] rounded-2xl bg-black/90 bg-cover bg-center shadow-lg/30' 
                    ...
                    <motion.img 
                        variants={logoVariants}
                        whileHover={{ scale: 1.05, boxShadow: "0 4px 20px #09c167",}}
                        whileTap={{ scale: 0.95, transition: { type: "spring", stiffness: 700, damping: 10 } }}                           
                    ...
                    <motion.img 
                        variants={logoVariants} 
                        whileHover={{ scale: 1.05, boxShadow: "0 4px 20px #ff5500",}}
                        whileTap={{ scale: 0.95, transition: { type: "spring", stiffness: 700, damping: 10 } }}                          
                    ...
                    <motion.img 
                        variants={logoVariants} 
                        whileHover={{ scale: 1.05, boxShadow: "0 4px 20px #34444e",}}
                        whileTap={{ scale: 0.95, transition: { type: "spring", stiffness: 700, damping: 10 } }}                          
                    ...
                    <motion.img 
                        variants={logoVariants}
                        whileHover={{ scale: 1.05, boxShadow: "0 4px 20px #c80016",}}
                        whileTap={{ scale: 0.95, transition: { type: "spring", stiffness: 700, damping: 10 } }}                          
            ...
            <div>
                <img src='images/logos/mappoint.svg' className="absolute right-8 2xl:right-24 top-39 2xl:top-48 size-[350px] 2xl:size-[500px] rounded-2xl" />
                <div className="absolute right-41 2xl:right-72 animate-[ping_2.0s_cubic-bezier(0,0,0.2,1)_infinite] top-58 2xl:top-77 size-8 2xl:size-9 bg-red-600 rounded-full"/>
            </div>
